...
So in the hidden page's source-code there's information about the direct-access-to-kings-landing route for what I can remember, unfortunately in the process of registering for this writeup, I forgot to copy and paste the source code of this specific page on a file.
