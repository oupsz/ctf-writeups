...
- School: 1 ~ VulnHub (official entry)
- School: 1 ~ VulnHub (series)
- SCHOOL:1 Vulnhub Machine Walkthrough — Ajay Sanchaniya, Medium
- SCHOOL:1 Walkthrough — H-ACK-ing (1dnz), Medium
- Exploiting Stack-Based BufferOverflows (NetStart, Foxlox) — F-Masood/GitHub
- PwnKit — CVE-2021-4034 (Qualys advisory)
- CVE-2019-11043 — PHP-FPM RCE (tested and discarded as not vulnerable)
